                    ...
                    <template x-teleport="body">
                        <div x-show="isFullscreen" x-effect="document.body.style.overflow = isFullscreen ? 'hidden' : ''"
                            ...
                            <button @click="isFullscreen = false"
                                ...
                                class="text-black hover:text-brand-800 transition-colors bg-[#edf6eb]/50 hover:bg-white rounded-full p-2 backdrop-blur-sm">
                            ...
                            <button @click.stop="prev()" x-show="images.length > 1"
                                ...
                                class="text-black hover:text-brand-800 bg-[#edf6eb]/50 hover:bg-white rounded-full p-2 backdrop-blur-sm transition-colors">
